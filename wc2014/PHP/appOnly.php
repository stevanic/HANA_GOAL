...
*/
function search_for_a_term($bearer_token, $query, $result_type='mixed', $count='15', $max_id='', $since_id=''){
	...
	if($max_id){$formed_url = $formed_url.'&max_id='.$max_id;} 
	if($since_id){$formed_url = $formed_url.'&since_id='.$since_id;}
	//if($lang){$formed_url = $formed_url.'&lang='.$lang;}
